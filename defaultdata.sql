...
78	vehicle_mile_view	公里数查看
79	vehicle_mile_edit	公里数修改
80	vehicle_file_extras	车辆附件文件
81	vehicle_file_annul	车辆年审文件
82	vehicle_file_fullcheck	车辆综合文件
...
\.
SELECT setval('action_id_seq',91);
